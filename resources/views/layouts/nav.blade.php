                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('product-service-categories.index') }}">Product Categories</a>
                            @endcan
                            ...
                            @endcan
                            @can('view-any', App\Models\ProductServiceCategory::class)
                            <a class="dropdown-item" href="{{ route('product-service-categories.index') }}">Product Service Categories</a>
                            @endcan
