...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-4">
                <div class="mb-4">
                    <h5>@lang('crud.services.inputs.product_id')</h5>
                    <span>{{ optional($service->timeline)->name ?? '-' }}</span>
                </div>
                <div class="mb-4">
                    <h5>@lang('crud.services.inputs.user_id')</h5>
                    <span>{{ optional($service->user)->name ?? '-' }}</span>
                </div>
            </div>
