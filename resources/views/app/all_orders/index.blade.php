    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.all_orders.index_title')</h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-right">
                                @lang('crud.all_orders.inputs.price')
                            </th>
                            <th class="text-left">
                                @lang('crud.all_orders.inputs.status')
                            </th>
                            <th class="text-left">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4">{!! $allOrders->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
