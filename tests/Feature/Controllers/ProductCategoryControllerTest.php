...
class ProductCategoryControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_product_categories()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('app.product_categories.index')
     ...
     * @test
     */
    public function it_displays_create_view_for_product_category()
    {
        $response = $this->get(route('product-categories.create'));

        $response->assertOk()->assertViewIs('app.product_categories.create');
    }
     ...
     * @test
     */
    public function it_displays_show_view_for_product_category()
    {
        ...
        $response
            ->assertOk()
            ->assertViewIs('app.product_categories.show')
     ...
     * @test
     */
    public function it_displays_edit_view_for_product_category()
    {
        $productCategory = ProductCategory::factory()->create();
        ...
        $response
            ->assertOk()
            ->assertViewIs('app.product_categories.edit')
            ->assertViewHas('productCategory');
    }
